...
}, P = (s) => [d.prefix, s, d.suffix].filter((e) => e && e.length > 0).join("-"), se = (s) => {
...
const V = /* @__PURE__ */ new WeakMap(), v = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), O = /* @__PURE__ */ new WeakMap();
function pe(s) {
...
function we(s) {
  ...
  } : fe().includes(s) ? function(...e) {
    return s.apply(I(this), e), f(V.get(this));
  } : function(...e) {
    return f(s.apply(I(this), e));
  };
}
function ye(s) {
  return typeof s == "function" ? we(s) : (s instanceof IDBTransaction && me(s), ue(s, de()) ? new Proxy(s, A) : s);
}
function f(s) {
  ...
  if (L.has(s))
    return L.get(s);
  const e = ye(s);
  return e !== s && (L.set(s, e), O.set(e, s)), e;
}
const I = (s) => O.get(s);
...
const Re = ["get", "getKey", "getAll", "getAllKeys", "count"], Ce = ["put", "add", "delete", "clear"], S = /* @__PURE__ */ new Map();
function B(s, e) {
  if (!(s instanceof IDBDatabase && !(e in s) && typeof e == "string"))
    return;
  if (S.get(e))
    return S.get(e);
  const t = e.replace(/FromIndex$/, ""), n = e !== t, a = Ce.includes(t);
  if (
...
const Ee = "workbox-expiration", R = "cache-entries", H = (s) => {
...
class xe {
  ...
  _upgradeDbAndDeleteOldDbs(e) {
    this._upgradeDb(e), this._cacheName && be(this._cacheName);
  }
  /**
   * @param {string} url
   ...
   */
  async getDb() {
    return this._db || (this._db = await _e(Ee, 1, {
...
class Le {
  ...
  async cachePut(e, t) {
    ...
    if (!r)
      return !1;
    const { cacheName: i, matchOptions: c } = this._strategy, o = await self.caches.open(i), l = this.hasCallback("cacheDidUpdate"), y = l ? await ne(
...
p.copyRedirectedCacheableResponsesPlugin = {
  async cacheWillUpdate({ response: s }) {
    return s.redirected ? await le(s) : s;
  }
};
class Ie {
  /**
  ...
  constructor({ cacheName: e, plugins: t = [], fallbackToNetwork: n = !0 } = {}) {
    this._urlsToCacheKeys = /* @__PURE__ */ new Map(), this._urlsToCacheModes = /* @__PURE__ */ new Map(), this._cacheKeysToIntegrities = /* @__PURE__ */ new Map(), this._strategy = new p({
      ...
      plugins: [
        ...t,
        new Pe({ precacheController: this })
      ],
      fallbackToNetwork: n
  ...
  addToCacheList(e) {
    ...
    for (const n of e) {
      ...
      const { cacheKey: a, url: r } = Ue(n), i = typeof n != "string" && n.revision ? "reload" : "default";
...
let N;
const G = () => (N || (N = new Ie()), N);
try {
  self["workbox:routing:7.2.0"] && _();
} catch {
}
const J = "GET", U = (s) => s && typeof s == "object" ? s : { handle: s };
class g {
  /**
   ...
   */
  constructor(e, t, n = J) {
    this.handler = U(t), this.match = e, this.method = n;
  }
  /**
   *
   * @param {workbox-routing-handlerCallback} handler A callback
...
class Ne {
  ...
  handleRequest({ request: e, event: t }) {
    ...
    const y = i && i.catchHandler;
    return l instanceof Promise && (this._catchHandler || y) && (l = l.catch(async (u) => {
      if (y)
        try {
          return await y.handle({ url: n, request: e, event: t, params: r });
        } catch (M) {
...
let C;
const ve = () => (C || (C = new Ne(), C.addFetchListener(), C.addCacheListener()), C);
function w(s, e, t) {
  let n;
  if (typeof s == "string") {
...
function* Oe(s, { ignoreURLParametersMatching: e = [/^utm_/, /^fbclid$/], directoryIndex: t = "index.html", cleanURLs: n = !0, urlManipulation: a } = {}) {
  const r = new URL(s, location.href);
  r.hash = "", yield r.href;
  const i = Ae(r, e);
...
function Ke(s) {
  const e = G(), t = new Me(e, s);
  w(t);
}
const je = "-precache-", We = async (s, e = je) => {
...
class T {
   ...
   */
  constructor(e) {
    this.cacheWillUpdate = async ({ response: t }) => this._cacheableResponse.isResponseCacheable(t) ? t : null, this._cacheableResponse = new Ve(e);
  }
}
he();
Fe();
He([{"revision":null,"url":"assets/customer.service.fixed-BwwfzteX.js"},{"revision":null,"url":"assets/CustomerDetailEnhanced-BgszoLjL.js"},{"revision":null,"url":"assets/CustomersEnhanced-09OTVS2s.js"},{"revision":null,"url":"assets/DashboardEnhanced-DJAes9U1.js"},{"revision":null,"url":"assets/index-3iixnlw3.css"},{"revision":null,"url":"assets/index-DEcLH6Mq.js"},{"revision":null,"url":"assets/InvoiceDetail-1eLyeCyU.js"},{"revision":null,"url":"assets/Invoices-BLyx14hy.js"},{"revision":null,"url":"assets/JobDetailTabbed-B1QdY4-b.js"},{"revision":null,"url":"assets/JobPhotos-HNxj0MFG.js"},{"revision":null,"url":"assets/Jobs-Bnr14A6v.js"},{"revision":null,"url":"assets/localStorage-DKzdD8oH.js"},{"revision":null,"url":"assets/Login-DXABXAaJ.js"},{"revision":null,"url":"assets/Materials-DeMTR3WJ.js"},{"revision":null,"url":"assets/OfflineDataDashboard-Bwthd3nw.js"},{"revision":null,"url":"assets/PracticalSecurity-D5DzxMxf.js"},{"revision":null,"url":"assets/Profile-DuaYsybU.js"},{"revision":null,"url":"assets/react-vendor-BLXwT7zj.js"},{"revision":null,"url":"assets/Reports-DFVunQVu.js"},{"revision":null,"url":"assets/ScheduleCalendar-BmxSHXq4.js"},{"revision":null,"url":"assets/SyncDebug-aibS-vmy.js"},{"revision":null,"url":"assets/ui-vendor-DuzoyoLP.js"},{"revision":null,"url":"assets/utils-vendor-BiZXfEo0.js"},{"revision":null,"url":"assets/worker.service-fRvciyjk.js"},{"revision":null,"url":"assets/Workers-CMRryk5J.js"},{"revision":"42090baf365a2cf0f88bf25eebcd7107","url":"index.html"},{"revision":"55419045fa2242c8e5132aaa21caa64c","url":"offline.html"},{"revision":"20d93ab60386dc581170e184274d055f","url":"registerSW.js"},{"revision":"a9c0f0f86b0e300a402639602e7fd962","url":"robots.txt"},{"revision":"55419045fa2242c8e5132aaa21caa64c","url":"offline.html"}]);
const m = {
  API: "khs-api-v1",
...
w(
  ({ url: s }) => {
    const e = s.pathname;
    return e.includes("/api/jobs") || e.includes("/api/customers") || e.includes("/api/materials");
  },
  new $e({
    cacheName: m.OFFLINE_DATA,
    plugins: [
      new T({
        statuses: [0, 200]
      }),
...
self.addEventListener("sync", (s) => {
  s.tag === "construction-data-sync" && s.waitUntil(Je());
});
async function Je() {
  try {
    const s = indexedDB.open("khs-crm-offline", 1);
    s.onsuccess = async () => {
      const n = s.result.transaction(["syncQueue"], "readonly").objectStore("syncQueue"), a = await new Promise((r) => {
        const i = n.getAll();
    ...
    throw console.error("Background sync failed:", s), s;
  }
}
async function ze(s) {
  const { entityType: e, operation: t, entityId: n, payload: a } = s;
  try {
    let r = "", i = "GET", c = null;
    switch (e) {
      case "customer":
        r = t === "create" ? "/api/customers" : `/api/customers/${n}`, i = t === "create" ? "POST" : t === "update" ? "PUT" : "DELETE", c = t !== "delete" ? JSON.stringify(a) : null;
        break;
      case "job":
        r = t === "create" ? "/api/jobs" : `/api/jobs/${n}`, i = t === "create" ? "POST" : t === "update" ? "PUT" : "DELETE", c = t !== "delete" ? JSON.stringify(a) : null;
        break;
      case "material":
        r = t === "create" ? `/api/jobs/${a.jobId}/materials` : `/api/materials/${n}`, i = t === "create" ? "POST" : t === "update" ? "PUT" : "DELETE", c = t !== "delete" ? JSON.stringify(a) : null;
        break;
    }
    (await fetch(r, {
      method: i,
    ...
    console.error("Failed to sync operation:", s, r);
  }
}
async function Xe(s) {
  const e = indexedDB.open("khs-crm-offline", 1);
  e.onsuccess = () => {
    e.result.transaction(["syncQueue"], "readwrite").objectStore("syncQueue").delete(s);
  };
}
  ...
  if (s.data)
    try {
      const e = s.data.json(), t = {
        body: e.body || "New update available",
        icon: "/icons/icon-192x192.png",
        badge: "/icons/icon-72x72.png",
        tag: e.tag || "khs-notification",
        data: e.data,
        requireInteraction: e.urgent || !1
      };
      e.type === "job-update" ? t.body = `Job ${e.jobTitle}: ${e.message}` : e.type === "material-needed" && (t.body = `Materials needed for ${e.jobTitle}`), s.waitUntil(
        self.registration.showNotification(e.title || "KHS CRM Update", t)
      );
    } catch (e) {
...
self.addEventListener("notificationclick", (s) => {
  ...
  const { action: e } = s, t = s.notification.data;
  let n = "/";
  switch (e) {
    case "view":
      n = t != null && t.jobId ? `/jobs/${t.jobId}` : "/jobs";
      break;
    case "view-materials":
      n = t != null && t.jobId ? `/jobs/${t.jobId}/materials` : "/materials";
      break;
    case "dismiss":
      return;
    default:
      n = (t == null ? void 0 : t.url) || "/";
  }
  s.waitUntil(
    self.clients.matchAll({ type: "window", includeUncontrolled: !0 }).then((a) => {
      for (const r of a)
        if (r.url.includes(n) && "focus" in r)
          return r.focus();
...
self.addEventListener("fetch", (s) => {
  s.request.mode === "navigate" && s.respondWith(
    fetch(s.request).catch(async () => {
      const e = await caches.match("/offline.html");
      return e || await caches.match("/index.html") || new Response("Offline", { status: 200 });
    })
  );
});
self.addEventListener("message", (s) => {
  var e, t, n;
  ((e = s.data) == null ? void 0 : e.type) === "SKIP_WAITING" && self.skipWaiting(), ((t = s.data) == null ? void 0 : t.type) === "CHECK_UPDATE" && ((n = s.ports[0]) == null || n.postMessage({
    type: "UPDATE_STATUS",
    hasUpdate: !1
    // This would be determined by checking app version
  }));
});
self.addEventListener("periodicsync", (s) => {
  s.tag === "construction-data-refresh" && s.waitUntil(Ye());
});
async function Ye() {
  try {
    const s = [
    ...
    console.error("Background data refresh failed:", s);
  }
}
self.addEventListener("quotaexceedederror", () => {
  caches.keys().then((s) => {
    s.forEach((e) => {
      e.includes("-v") && !Object.values(m).includes(e) && caches.delete(e);
    });
  });
});
self.addEventListener("install", (s) => {
  console.log("KHS CRM Service Worker installing..."), s.waitUntil(
    caches.open(m.OFFLINE_DATA).then((e) => e.addAll([
      "/",
      "/offline.html",
      "/manifest.json"
    ]).catch((t) => {
      console.warn("Failed to pre-cache some resources:", t);
    }))
  );
});
self.addEventListener("activate", (s) => {
  console.log("KHS CRM Service Worker activated"), s.waitUntil(
    // Clean up old caches
    caches.keys().then((e) => Promise.all(
      e.map((t) => {
        if (t.includes("khs-") && !Object.values(m).includes(t))
